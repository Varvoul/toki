...
# Install PHP extensions - use mongodb 1.15.0 (composer.lock needs ext-mongodb ^1.13.0)
RUN install-php-extensions intl mbstring mongodb@1.15.0 redis opcache sockets pcntl 2>&1
